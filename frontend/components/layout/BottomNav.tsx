    ...
    <div className="fixed bottom-3 left-0 right-0 z-50 flex justify-center px-4 md:hidden pointer-events-none pb-safe">
      <nav className="flex w-full max-w-sm items-center justify-between gap-2 pointer-events-auto">
        ...
        <Link 
          href="/predictions" 
          className={cn(
            "flex h-[64px] w-[64px] shrink-0 items-center justify-center rounded-full shadow-[0_8px_32px_rgb(23,37,84,0.4)] transition-transform active:scale-90",
            isActive("/predictions") 
              ? "bg-blue-900 text-white shadow-[0_8px_32px_rgb(23,37,84,0.5)]" 
